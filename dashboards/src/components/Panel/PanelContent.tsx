...
export function PanelContent(props: PanelContentProps): ReactElement {
  ...
  const { data: plugin, isLoading: isPanelLoading } = usePlugin('Panel', panelPluginKind, { throwOnError: true }); // LOGZ.IO CHANGE: `useErrorBoundary` was changed to `throwOnError` for tanstack query v4 -> v5 support
