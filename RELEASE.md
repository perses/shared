...
2. Bump the version of the libraries running [pnpm-bump.go](./scripts/pnpm-bump/pnpm-bump.go) `go run ./scripts/pnpm-bump <new version>`. For example: `go run ./scripts/pnpm-bump 1.2.3`.
3. Run `pnpm install`
